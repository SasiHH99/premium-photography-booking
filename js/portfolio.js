const PORTFOLIO_TEXT = {
  hu: {
    ...
    heroCopy: "Portrék, páros sorozatok, természetes, autós, baba-családi és kreatív képek Bécsből és környékéről, valódi fényekkel és túlstilizálás nélkül.",
    allLabel: "Összes kategória",
    totalLabel: "Válogatott képek",
    ctaTitle: "Ha ezt a vizuális minőséget a saját képeidnél is szeretnéd, innen megyünk tovább.",
    ctaCopy: "A fotózás nem sabloncsomag. Először megbeszéljük, mire van szükséged, utána állítjuk össze az időpontot, a helyszínt és a legerősebb irányt.",
